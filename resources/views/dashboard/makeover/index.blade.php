                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('makeover.create') }}" type="button" class="btn btn-success btn-sm">Add New Design</a>
                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('makeover.edit', [$item->id]) }}" class="me-2">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <form method="GET" action="{{ route('makeover.delete', $item->id) }}" class="d-inline">
                                                    @csrf
                                                    <input name="_method" type="hidden" value="DELETE">
                                                    <a href="{{ route('makeover.delete', $item->id) }}" class="show_confirm" data-toggle="tooltip" title="Delete">
